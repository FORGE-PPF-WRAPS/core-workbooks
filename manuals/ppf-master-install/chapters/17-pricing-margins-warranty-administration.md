...
# Chapter 17 — Pricing, Margins & Warranty Administration


Labor hours by panel, material waste factor, warranty registration, claim documentation, and customer education.
...
### Pricing, Margins & Warranty Administration — Shop SOP Sequence

1. Review work order and confirm vehicle/package match
2. Verify environmental conditions (temperature, humidity, cleanliness)
3. Stage all tools and materials before vehicle enters install zone
4. Execute procedure steps without skipping documented checkpoints
5. Document completion with photos where required
6. Lead installer signs QC before customer notification
...
**Shop standard:** Post a one-page Pricing, Margins & Warranty Administration quick-reference at the bay. Field crews reference SOPs during production — not after comebacks.
